        ...
        function calculateDistances() {
            measurementPoints.forEach((point, index) => {
                ...
                if (pointCounter === 1) {
                    ...
                    endKm.push(closestPointDistanceOnTrack.toFixed(3));
                    endAbst.push(distanceInMeters.toFixed(3));

                } else if (pointCounter === 0) {
                    // Wenn nur ein Punkt vorhanden ist, haben wir noch kein Teilstück
                    // Initialisiere das erste Teilstück
                    startKm.push(closestPointDistanceOnTrack.toFixed(3));
                    startAbst.push(distanceInMeters.toFixed(3));
